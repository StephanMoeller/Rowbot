...
{
    public class AsyncDataReaderSource_Test
    {
        [Fact]
        public async Task GetColumnsAndRows_NoRows_Test()
        {
            ...
            var source = new AsyncDataReaderSource(dataTable.CreateDataReader());
        ...
        public async Task GetColumnsAndRows_NoColumns_ExpectException_Test()
        {
            var dataTable = new DataTable();
            var source = new AsyncDataReaderSource(dataTable.CreateDataReader());
            Assert.Empty(await source.InitAndGetColumnsAsync());
        }
